...
[See setting of annotation processor](http://code.google.com/p/multiindexcontainer/wiki/IndexConstantGenerator)

Due to annotation processing new class Person\_Indexes.java has been automatically generated
```
